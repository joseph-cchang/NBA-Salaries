...
master_data <- merge(new_bball_stats, data_advanced, by ='Player')
#all_data <- subset(master_data, select= -c(4,29,31,32,45))
...
my_cor <- all_data %>% select(-c(Player, Position.x, Team.x)) %>% cor() %>% round(5)
