...
In this section, we'll merge the two
...
```{r}
salarycor <- our_data %>% select(Salary,Games.Played,PPG,RPG,APG,SPG,BPG,TPG,MPG,Usage_Rate,`Free throw%`,`three-point %`,Versatility_Index,`Offensive Rating`,`Defensive rating`,win.shares,Box.Plus.Minus,Value.Over.Replacement) %>% drop_na()
#ggpairs(salarycor)
