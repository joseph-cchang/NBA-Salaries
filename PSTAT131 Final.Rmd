...
First, we read in the data that we downloaded from \_\_\_\_\_.

```{r}
# this is where we will import the data 
...
We can see in the summary that the tree modeled by the training set has 10 terminal nodes, whereas the previous tree only had 7 terminal nodes.
