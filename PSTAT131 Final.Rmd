...
## Code for Categorical Decision Tree:
...
glimpse(our_data)
tree_our_data=tree(High~.-c(Player,Salary),data = our_data) 
...
*Now we are going to focus on calculating the respective test error rate for the model
