...
selection <- subset(combine, select= -c(2:4,7,9,10,12:14,20,22,29:31,32,35:47,49:51,54, 56:57))
...
my_cor <- our_data2 %>% select(c(Games.Played: Salary)) %>% cor() %>% round(3)
typeof(my_cor)
