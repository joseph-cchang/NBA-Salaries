...
This is where we put the final dataset. It has our players, their salaries, and the 9 predictors we want. We will be refering to our_data the rest of the project. As a start to visualize the data, we plotted the response variable Salary using a histogram and another histogram consisting of PPG vs Salaries.
