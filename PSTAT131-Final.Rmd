...
Based from the 3 fitted models, the largest R-squared came from fit1 at around 0.65. Next, I chose the model with the least MSE for training and testing. fit1 had the least MSE for training, but fit3 had the least MSE for testing. To break the tie, I will consider the R-squared again, meaning fit1 is most appropriate.
...
salary_prediction(m = model, points = 20, assists = 5, minutes = 30, turnovers = 2, minutes_p = 60, free_throws = 80, offense_plus_minus = 2.3, value = 1.3)
```
