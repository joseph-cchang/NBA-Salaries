...
This part is dedicated for the ridge regression. I first defined the list of lambda values the model can take, and used 5-folds on the training data to predict the coefficients of each predictor. This shows how much ... 
